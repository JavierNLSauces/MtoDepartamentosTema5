...
define('DNS','mysql:host=192.168.8.217:3306;dbname=DAW217DBProyectoTema5;charset=utf8'); // Direccion del host y nombre de la base de datos para la conexion con la base de datos
