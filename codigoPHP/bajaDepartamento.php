...
if (isset($_REQUEST['Aceptar'])) { // si la entrada esta bien recojo los valores introducidos y hago su tratamiento
    try { // Bloque de código que puede tener excepciones en el objeto PDO
        ...
        $sqlBorrado = "DELETE FROM T02_Departamento WHERE T02_CodDepartamento=:CodDepartamento";
            ...
            <main class="flex-container-align-item-center">
                <form name="departamento" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div>
                        ...
                        <input type="text" id="FechaBaja" name="FechaBaja" value="<?php echo empty($fechaBaja)?"NULL": date('d/m/Y',$fechaBaja); // si la fecha esta vacia imprime null, si no su valor?>" readonly>
                    </div>
                    <div>
